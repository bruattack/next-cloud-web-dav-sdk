    ...
    public function getListingFolder($folder = '')
    {
        ...
        if (!empty($structures)) {
            foreach ($structures as $key => $structure) {
                ...
                $result[] = array(
                    'path' => $key,
                    'element-name' => $parsepath['filename']??null,
                    'getlastmodified' => $structure['{DAV:}getlastmodified']??null,
                    'getetag' => $structure['{DAV:}getetag']??null,
                    'getcontenttype' => $structure['{DAV:}getcontenttype']??null,
                    'resourcetype' => $resourcetype??null,
                    'getcontentlength' => $structure['{DAV:}getcontentlength']??null,
                    'id' => $structure['{http://owncloud.org/ns}id']??null,
                    'fileid' => $structure['{http://owncloud.org/ns}fileid']??null,
                    'favorite' => $structure['{http://owncloud.org/ns}favorite']??null,
                    'comments-href' => $structure['{http://owncloud.org/ns}comments-href']??null,
                    'comments-count' => $structure['{http://owncloud.org/ns}comments-count']??null,
                    'comments-unread' => $structure['{http://owncloud.org/ns}comments-unread']??null,
                    'owner-id' => $structure['{http://owncloud.org/ns}owner-id']??null,
                    'owner-display-name' => $structure['{http://owncloud.org/ns}owner-display-name']??null,
                    'share-types' => $shareTypes??null,
                    'checksums' => $structure['{http://owncloud.org/ns}checksums']??null,
                    'has-preview' => $structure['{http://owncloud.org/ns}has-preview']??null,
                    'size' => $structure['{http://owncloud.org/ns}size']??null
                );
